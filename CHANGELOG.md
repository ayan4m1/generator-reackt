...
- automatically update changelog when versioning [`2a47d42`](https://git.codecube.xyz/web/generator-reackt/commit/2a47d42820be95777dbc65492c233495fd16a21e)
- use @babel/eslint-parser in template eslintrc [`76468f6`](https://git.codecube.xyz/web/generator-reackt/commit/76468f6f20e8678dc46a0a0a44f7bce398771b52)
- replace node-sass with dart-sass [`c7d602b`](https://git.codecube.xyz/web/generator-reackt/commit/c7d602b4da0132ede0309ed53ae14e6055fc6afd)
- drop yeoman-generator back to 4.x [`88623cb`](https://git.codecube.xyz/web/generator-reackt/commit/88623cbe2adc79cc8d2bbd09d161df9eecc80725)
- add prepublishOnly script [`dd87e7f`](https://git.codecube.xyz/web/generator-reackt/commit/dd87e7f56766401042b4f795ca01327dcae1e3a4)
- disable commit limit for auto-changelog [`7fa3d7d`](https://git.codecube.xyz/web/generator-reackt/commit/7fa3d7d92d04c9580fc7c9b75bc6ac9630510e40)
- add more commits to changelog [`ce8bb2d`](https://git.codecube.xyz/web/generator-reackt/commit/ce8bb2d1f6c3800cf95e605e7f611cf8bff2b51c)
- bump minimum node version to 12 [`0413ab1`](https://git.codecube.xyz/web/generator-reackt/commit/0413ab17a1cf0736a2c134c58513f6656229e46d)
- fix default app name containing spaces [`31fbe2b`](https://git.codecube.xyz/web/generator-reackt/commit/31fbe2b52af74bb86164512ceb180fd54f329645)

#### [v0.2.6](https://git.codecube.xyz/web/generator-reackt/compare/v0.2.5...v0.2.6)

> 16 April 2021

- remove whitelist/blacklist from .stylelintrc [`5f98d6e`](https://git.codecube.xyz/web/generator-reackt/commit/5f98d6e71b5dae5c28294f98a9a9cf0280f2cd74)
- fix webpack 5 builds and switch to css-minimizer-webpack-plugin [`765854a`](https://git.codecube.xyz/web/generator-reackt/commit/765854aec783988d5e9182d52fc37806f08c71ef)
- fix stylelint rule that changed [`1ef1eeb`](https://git.codecube.xyz/web/generator-reackt/commit/1ef1eeb973224f2d06113f4fa4a2b3cbfb0e60ce)
- remove unnecessary prettier rule import [`a572e50`](https://git.codecube.xyz/web/generator-reackt/commit/a572e50602270391407b0a45245b96972b42a67c)

#### [v0.2.5](https://git.codecube.xyz/web/generator-reackt/compare/v0.2.4...v0.2.5)

> 29 January 2021

- upgrade all dependencies [`7511b40`](https://git.codecube.xyz/web/generator-reackt/commit/7511b40c73b05ca9af18682e5b55b6516448d2ad)
- migrate from eslint-loader to eslint-webpack-plugin, make some webpack 5 fixes [`55b95ef`](https://git.codecube.xyz/web/generator-reackt/commit/55b95efa887a36240abb86b23f6415a4363fae24)

#### [v0.2.4](https://git.codecube.xyz/web/generator-reackt/compare/v0.2.3...v0.2.4)

> 5 December 2020

- upgrade all dependencies [`0e976aa`](https://git.codecube.xyz/web/generator-reackt/commit/0e976aaa8d5ce0f1d75483324c8cc531aafb234b)
- upgrade all dependencies [`1c30a55`](https://git.codecube.xyz/web/generator-reackt/commit/1c30a5560851e1cbd25d805d0002609b77f112a7)
- change webpack start script [`e7f3d97`](https://git.codecube.xyz/web/generator-reackt/commit/e7f3d974cc43f1507242d3217ec0f261392254bf)

#### [v0.2.3](https://git.codecube.xyz/web/generator-reackt/compare/v0.2.2...v0.2.3)

> 9 October 2020

- add missing files to package.json [`957b188`](https://git.codecube.xyz/web/generator-reackt/commit/957b18868cf1983cec7b8e4f42ba76dd5312290d)

#### [v0.2.2](https://git.codecube.xyz/web/generator-reackt/compare/v0.2.1...v0.2.2)

> 23 May 2020

- update app for latest prettier changes and upgrade all dependencies [`3a87a7b`](https://git.codecube.xyz/web/generator-reackt/commit/3a87a7b8743388d7cc748753d1da7b2342057f09)
- upgrade all dependencies [`ee69d12`](https://git.codecube.xyz/web/generator-reackt/commit/ee69d1247344b96fd7cda5fd16d5d1ba46043e7f)
- add test script to generated package.json [`bc09b6e`](https://git.codecube.xyz/web/generator-reackt/commit/bc09b6e4488dddba6e4263df614b390642b847f3)
- fix dummy icon not existing [`8ba0c62`](https://git.codecube.xyz/web/generator-reackt/commit/8ba0c627de2a01da3821ac23fa0b6ec9d0446aa0)

#### [v0.2.1](https://git.codecube.xyz/web/generator-reackt/compare/v0.2.0...v0.2.1)

> 30 December 2019

- update dependencies [`b318aae`](https://git.codecube.xyz/web/generator-reackt/commit/b318aaedd1ee9549583bea5048a6ae3733fa735c)
- update dependencies [`e730be8`](https://git.codecube.xyz/web/generator-reackt/commit/e730be8fb8370b4575316adf7c25f3e663a265bf)
- fixes and improvements to webpack.config.babel.js [`5a1113c`](https://git.codecube.xyz/web/generator-reackt/commit/5a1113ccf6fc6c329b4747db966502adf91d5d17)
- fix prettier config load [`ebff869`](https://git.codecube.xyz/web/generator-reackt/commit/ebff86933188f6b9c6c5e577cea90884e02bdbfa)
- break icons out into separate file if fontawesome is being installed [`5fc41dd`](https://git.codecube.xyz/web/generator-reackt/commit/5fc41ddd65e0967315a3a668ea421935af2f5ac6)
- add missing package prettier-stylelint [`2f75de1`](https://git.codecube.xyz/web/generator-reackt/commit/2f75de1db2cafb2b79ff7f94d65640a302ab8d00)

#### [v0.2.0](https://git.codecube.xyz/web/generator-reackt/compare/v0.1.6...v0.2.0)

> 15 September 2019

#### [v0.1.6](https://git.codecube.xyz/web/generator-reackt/compare/v0.1.5...v0.1.6)

> 15 September 2019

- update dependencies [`3ef52ff`](https://git.codecube.xyz/web/generator-reackt/commit/3ef52ffc9179ab573e9e69ccd53795fb4a472d59)
- update dependencies [`e8d7884`](https://git.codecube.xyz/web/generator-reackt/commit/e8d7884b0ace131c4a81019b66c0e9fa682116d5)
- add auto-generated CHANGELOG.md [`1c85797`](https://git.codecube.xyz/web/generator-reackt/commit/1c85797864e76c76025e2fb8e210add3c353275d)
- sync package-lock.json [`c1d82f5`](https://git.codecube.xyz/web/generator-reackt/commit/c1d82f53e812b8054ad5375c70ae205dab31edfd)
- read .prettierrc to configure gulp-prettier [`f4b43a4`](https://git.codecube.xyz/web/generator-reackt/commit/f4b43a4c3ed6c399d03fc50789b6458307ce973c)
- always import BrowserRouter, only import Provider-wrapped app if addRedux [`7a7dbe5`](https://git.codecube.xyz/web/generator-reackt/commit/7a7dbe58a01d5462509ad3b9c573e474b8670183)
- bump version to 0.1.6 [`2ed0133`](https://git.codecube.xyz/web/generator-reackt/commit/2ed01334b50657cfcc4490739e792fd670474c36)
- add missing import [`7227d32`](https://git.codecube.xyz/web/generator-reackt/commit/7227d325bbbbfc1ba7f89f34edc59696a631d293)
- fix date format [`3dfb75b`](https://git.codecube.xyz/web/generator-reackt/commit/3dfb75bf690f08875c2c956017771653878a9dc2)
- add missing react-router-dom package [`ec066a6`](https://git.codecube.xyz/web/generator-reackt/commit/ec066a616d9113f9abb0edbd3e80f89c773765df)
- move App.js to the correct location [`0cd10a8`](https://git.codecube.xyz/web/generator-reackt/commit/0cd10a8b34c247201fffcd10aed955e335f62f67)

#### [v0.1.5](https://git.codecube.xyz/web/generator-reackt/compare/v0.1.4...v0.1.5)
...
#### [v0.1.4](https://git.codecube.xyz/web/generator-reackt/compare/v0.1.3...v0.1.4)
...
#### [v0.1.3](https://git.codecube.xyz/web/generator-reackt/compare/v0.1.2...v0.1.3)
...
#### [v0.1.2](https://git.codecube.xyz/web/generator-reackt/compare/v0.1.1...v0.1.2)
...
#### [v0.1.1](https://git.codecube.xyz/web/generator-reackt/compare/v0.1.0...v0.1.1)
